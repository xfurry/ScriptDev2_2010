...
enum
{
	...
	// Addition
	TYPE_PHASE						= 9,					// used to counter the event phase
    TYPE_ENCOUNTER					= 10,					// used to counter the event encounter
    TYPE_WING						= 11,					// used to counter the waves side
	TYPE_ZOMBIEFEST					= 12,					// used at zombiefest

	TYPE_WAVE_COUNT					= 13,					// used to counter the waves
    TYPE_ZOMBIE_COUNT				= 14,					// used to count the zombies
